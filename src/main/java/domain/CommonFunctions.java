...
public class CommonFunctions {
        /**
         * Function for removing excess whitespace in string input.
         * Example input: "   foo     bar" Returns: "foo bar".
         * @param s
         * @return 
         */
...
/**
 * Problem with current implementation, in the for loop, can't have the "BetObject" be of type Model but that's what the list has to be of.
 * Which in turn leads to the call t.getName trying to call a getName function in Model which doesn't exist.
 */
//        /**
